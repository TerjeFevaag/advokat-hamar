...
import pageData from '@/content/bedrift-eiendom-mangler.json'
...
export default function BedriftManglerfastEiendomPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/eiendom/mangler-ved-fast-eiendom" title="Mangler ved fast eiendom" topics={pageData.topics} />
      <main>
        {/* Hero */}
