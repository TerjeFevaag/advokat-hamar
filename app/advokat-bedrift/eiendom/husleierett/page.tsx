...
import pageData from '@/content/bedrift-husleierett.json'
...
export default function BedriftHusleierettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/eiendom/husleierett" title="Husleierett næring" topics={pageData.topics} />
      <main>
        {/* Hero */}
