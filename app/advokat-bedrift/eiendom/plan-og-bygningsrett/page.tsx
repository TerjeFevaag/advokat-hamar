...
import pageData from '@/content/bedrift-plan-bygningsrett.json'
...
export default function BedriftPlanOgBygningsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/eiendom/plan-og-bygningsrett" title="Plan- og bygningsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
