...
import pageData from '@/content/bedrift-selskapsrett.json'
...
export default function SelskapsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/selskapsrett" title="Selskapsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
