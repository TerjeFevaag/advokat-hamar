...
import pageData from '@/content/bedrift-kjopsrett.json'
...
export default function KjopsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/kjopsrett" title="Kjøpsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
