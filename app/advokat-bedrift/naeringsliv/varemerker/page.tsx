...
import pageData from '@/content/bedrift-varemerker.json'
...
export default function VaremerkerPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/varemerker" title="Varemerker" topics={pageData.topics} />
      <main>
        {/* Hero */}
