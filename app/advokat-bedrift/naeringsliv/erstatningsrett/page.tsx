...
import pageData from '@/content/bedrift-erstatningsrett.json'
...
export default function BedriftErstatningsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/erstatningsrett" title="Erstatningsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
