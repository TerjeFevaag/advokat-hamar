...
import pageData from '@/content/bedrift-opphavsrett.json'
...
export default function OpphavsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/opphavsrett" title="Opphavsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
