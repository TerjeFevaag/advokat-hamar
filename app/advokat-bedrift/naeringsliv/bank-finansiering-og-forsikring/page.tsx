...
import pageData from '@/content/bedrift-bank-finansiering.json'
...
export default function BankFinansieringOgForsikringPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/bank-finansiering-og-forsikring" title="Bank og finansiering" topics={pageData.topics} />
      <main>
        {/* Hero */}
