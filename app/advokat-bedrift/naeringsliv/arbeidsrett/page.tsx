...
import pageData from '@/content/bedrift-arbeidsrett.json'
...
export default function BedriftArbeidsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-bedrift/naeringsliv/arbeidsrett" title="Arbeidsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
