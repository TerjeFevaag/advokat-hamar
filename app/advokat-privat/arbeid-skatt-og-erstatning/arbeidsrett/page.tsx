...
import pageData from '@/content/privat-arbeidsrett.json'
...
export default function PrivatArbeidsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/arbeid-skatt-og-erstatning/arbeidsrett" title="Arbeidsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
