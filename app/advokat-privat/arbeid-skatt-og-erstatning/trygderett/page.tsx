...
import pageData from '@/content/privat-trygderett.json'
...
export default function TrygderettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/arbeid-skatt-og-erstatning/trygderett" title="Trygderett" topics={pageData.topics} />
      <main>
        {/* Hero */}
