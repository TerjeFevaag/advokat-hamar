...
import pageData from '@/content/privat-skatterett.json'
...
export default function PrivatSkatterettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/arbeid-skatt-og-erstatning/skatterett" title="Skatterett" topics={pageData.topics} />
      <main>
        {/* Hero */}
