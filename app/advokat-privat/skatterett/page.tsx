...
import pageData from '@/content/skatterett.json'
...
export default function SkatterettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/skatterett" title="Skatterett" topics={pageData.topics} />
      <main>
        {/* Hero */}
