...
import pageData from '@/content/privat-naborett.json'
...
export default function NaborettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/eiendom/naborett" title="Naborett" topics={pageData.topics} />
      <main>
        {/* Hero */}
