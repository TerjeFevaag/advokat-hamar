...
import pageData from '@/content/privat-plan-bygningsrett.json'
...
export default function PrivatPlanOgBygningsrettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/eiendom/plan-og-bygningsrett" title="Plan- og bygningsrett" topics={pageData.topics} />
      <main>
        {/* Hero */}
