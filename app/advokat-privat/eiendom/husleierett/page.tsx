...
import pageData from '@/content/privat-husleierett.json'
...
export default function PrivatHusleierettPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/eiendom/husleierett" title="Husleierett" topics={pageData.topics} />
      <main>
        {/* Hero */}
