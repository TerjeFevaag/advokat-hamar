...
import pageData from '@/content/privat-samlivsbrudd.json'
...
export default function SamlivsbruddPage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/familie-og-arv/samlivsbrudd" title="Samlivsbrudd" topics={pageData.topics} />
      <main>
        {/* Hero */}
