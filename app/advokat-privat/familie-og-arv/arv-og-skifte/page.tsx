...
import pageData from '@/content/privat-arv-skifte.json'
...
export default function ArvOgSkiftePage() {
  return (
    <>
      <Navigation darkHero />
        <ServiceJsonLd path="/advokat-privat/familie-og-arv/arv-og-skifte" title="Arv og skifte" topics={pageData.topics} />
      <main>
        {/* Hero */}
        ...
        <section className="py-14 px-8 md:px-20 bg-cream border-t border-gray-100">
          <div className="max-w-6xl mx-auto">
            ...
            <Link href="/artikler/generasjonsskifte-familiebedrift" className="group flex items-center justify-between bg-white rounded-2xl p-7 border border-gray-100 hover:border-gold hover:shadow-soft transition-all duration-300">
              <div>
                <p className="text-xs text-gray-400 mb-1">Artikkel · Mars 2026</p>
                <h3 className="font-serif text-lg font-bold text-navy group-hover:text-gold transition-colors">Slik planlegger du et vellykket generasjonsskifte</h3>
                <p className="text-gray-500 text-sm mt-1">Tidlig planlegging er nøkkelen til et smidig generasjonsskifte i familiebedrifter.</p>
              </div>
